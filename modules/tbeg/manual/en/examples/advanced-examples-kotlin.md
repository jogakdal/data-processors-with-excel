> **[한국어](../../ko/examples/advanced-examples-kotlin.md)** | English

# TBEG Advanced Examples (Kotlin)
...
> Passing a lambda to `image()` defers expensive operations like DB queries or external API calls until the image is actually needed.
...
### Code (simpleDataProvider DSL - Lazy Loading)
